...
The exercise is done in the script \lstinputlisting{poisson.py}. The necessary explanations are in the comments of the code. The output produced for the values required is in \texttt{poisson$\_$output.txt}.
